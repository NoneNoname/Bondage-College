...
function PreferenceInit(C) {
  ...
  if (C.ChatSettings.ShowChatHelp == null) C.ChatSettings.ShowChatHelp = true;
...
function PreferenceSubscreenChatRun() {
  ...
  DrawCheckbox(1200, 732, 64, 64, TextGet("ShowChatRoomHelp"), Player.ChatSettings.ShowChatHelp);
	MainCanvas.textAlign = "center";
...
function PreferenceSubscreenChatClick() {
  ...
  if (MouseIn(1200, 732, 64, 64)) Player.ChatSettings.ShowChatHelp = !Player.ChatSettings.ShowChatHelp;
